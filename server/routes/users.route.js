...
// router.post('/removeUser', asyncHandler(removeUser), msg);
...
function msg(req, res) {
    ...
    async function removeUser(req, res, next) {
        ...
        const user = req.body;
        req.msg = await userController.removeUser(user);
    
        if(!req.msg.acknowledged) {
            req.msg = "Error: User removal is Unsuccessfull";
        }
        else {
            req.msg = "User is removed successfully!";
        }
